                  ...
                  <div class="admin d-flex align-items-center rounded-2 p-3 mb-4">
                    <div class="img">
                      <img class="img-fluid rounded-pill"
                           width="75" height="75"
                           src="../image/mark/<?php echo$row['image'];?>"
                           alt="admin">
                    </div>
                    <div class="ms-3">
                    ...
                    <div class="ms-3">
                    <a href="edit_mark.php?rn=<?php echo$row['id'];?>"><button type="button" class="btn btn-info">Edit</button></a>
                    <a href="../controlers/dalete_mark.php?rn=<?php echo$row['id'];?>"><button type="button" class="btn btn-danger">Delet</button></a>
                  </div>
                  </div>
